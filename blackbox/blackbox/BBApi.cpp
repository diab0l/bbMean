...
//===========================================================================
static void fn_write_error(const char *filename)
{
...
//===========================================================================
static bool find_resource_file(char* pszOut, const char* filename, const char* basedir)
{
    char temp[MAX_PATH];
...
static BOOL CALLBACK fnEnumMonProc(HMONITOR hMon, HDC hdcOptional, RECT *prcLimit, LPARAM dwData)
{
    struct _screen * s;
